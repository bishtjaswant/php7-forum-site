<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <a class="nav-link" href="http://localhost/php-online-forum-project/pages/about.php">About</a>
            ...
            <div class="row">
                ...
                <button data-toggle="modal" data-target="#signup" class="font-weight-bold btn btn-md btn-outline-success mr-2" style="background-color: #eee;color:black;">Signup</button>
            </div>
        </div>
    </nav>